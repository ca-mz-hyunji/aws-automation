...
# account 이름을 인풋으로 받은 후, Session Connect
def assume_role(account):
    try:
        # Create STS client = Security Tocken Service - AWS 리소스에 대한 엑세스를 제어할 수 있는 임시 보안 자격 증명
        sts_client = boto3.client('sts')
        # Create an Assume Role - STS.Client.assume_role(**kwargs) - returns a set of temp
...
# Jira configuration
JIRA_PROJECT_KEY = 'HAEA'
JIRA_ISSUE_TYPE = "Task"
JIRA_SYSTEM_ACCOUNT = "712020%3Aa27630fb-3cf9-4e3a-a6b4-1235d5e5621d"
# Confluence configuration
CONFLUENCE_SPACE_KEY = 'CCSD'
